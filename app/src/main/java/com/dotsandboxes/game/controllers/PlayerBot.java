...
public class PlayerBot {
    ...
    Preferenc preferenc;
    Context context;
    public PlayerBot(Game game, Context context) {
        this.game = game;
    ...
    public Edge getNextMove() {
        ...
        preferenc=new Preferenc(context);
        String mode=preferenc.getString();
        ...
        // otherwise get a random available move
            ...
            for (Edge moveToMake : availableMoves) {
                ...
                while (opponentCompletionMoves.size() > 0) {
                    ...
                    Log.d("Tag","OP"+opponentCompletionMoves.toString());
                }
                ...
                if (opponentScore < minOpponentScoreAfterMove) {
                    ...
                    if (mode.equals("medium")){
                        ...
                        moveToMake=availableMoves.get(0);
                    }
                    nextMove =moveToMake;
                }
            }
